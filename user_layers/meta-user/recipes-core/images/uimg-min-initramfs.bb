...
# Class image-artifact-names adds a ".rootfs" suffix to image before its extension.
# When the kernel-fitimage looks for an image in deploy it expects to find a
